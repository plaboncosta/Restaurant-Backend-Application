            ...
            <div class="tile-body">
              <form action="{{url('admin/supplier/update/'.$supplier->id)}}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="number" id="phone" name="number" class="form-control"  value="{{$supplier->number}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>Date</label>
                  <input type="text" id="datetimepicker" name="date" class="form-control" value="{{$supplier->date}}">
                </div>
